# PID gain constants
PROPORTIONAL_VAR = 0.5
DIFFERENTIAL_VAR = 0.1
INTEGRAL_VAR = 0.01
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # PID calculation
        if largestBlob is not None:
            error = 320 - largestBlob.x  # Assuming 320 is the center of the image
            ...
            twist.linear.x = 0.2
            old_error = error  # Update old_error for the next iteration
            print("blob!")
        else:
            twist.angular.z = 0
            twist.linear.x = 0
            integral = 0  # Reset integral when no blob is detected
            print("no blob!")
